...
abstract class BaseBarPagingKActivityVDBVM<DES : Any, VDB : ViewDataBinding, VM : BasePagingKViewModel<*, DES>> : BasePagingKActivityVDBVM<DES, VDB, VM>, IToolbarProxyProvider, IToolbarProxy {
    /**
    ...
    protected val toolBarProxy by UtilKLazyJVM.lazy_ofNone { ToolbarProxy<BaseBarPagingKActivityVDBVM<*, *, *>>().apply { bindLifecycle(this@BaseBarPagingKActivityVDBVM) } }
