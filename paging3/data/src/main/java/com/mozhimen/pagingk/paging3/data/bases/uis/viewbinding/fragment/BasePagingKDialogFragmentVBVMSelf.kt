 ...
 * @Version 1.0
 */
abstract class BasePagingKDialogFragmentVBVMSelf<DES : Any, VB : ViewBinding, VM : BasePagingKViewModel<*, DES>> : BaseDialogFragmentVBVMSelf<VB, VM>(), IPagingKActivity<DES, VM> {

    @OptIn(OApiInit_ByLazy::class, OApiCall_BindLifecycle::class, OApiCall_BindViewLifecycle::class)
    private val _pagingKProxy by UtilKLazyJVM.lazy_ofNone { PagingKProxy<DES, VM>(this).apply { bindLifecycle(this@BasePagingKDialogFragmentVBVMSelf) } }
