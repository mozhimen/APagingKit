...
import com.mozhimen.uik.databinding.bases.viewdatabinding.fragment.BaseDialogFragmentVDBVMVMSelf
 ...
 * @Version 1.0
 */
abstract class BasePagingKDialogFragmentVDBVMVMSelf<DES : Any, VDB : ViewDataBinding, VMSELF : BasePagingKViewModel<*, DES>, VMSHARE : BaseViewModel> :
    BaseDialogFragmentVDBVMVMSelf<VDB, VMSHARE, VMSELF>(), IPagingKActivity<DES, VMSELF> {

    @OptIn(OApiInit_ByLazy::class, OApiCall_BindLifecycle::class, OApiCall_BindViewLifecycle::class)
    private val _pagingKProxy by UtilKLazyJVM.lazy_ofNone { PagingKProxy<DES, VMSELF>(this).apply { bindLifecycle(this@BasePagingKDialogFragmentVDBVMVMSelf) } }
