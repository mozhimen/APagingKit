 ...
 * @Version 1.0
 */
abstract class BasePagingKDialogFragmentVDBVMSelf<DES : Any, VDB : ViewDataBinding, VM : BasePagingKViewModel<*, DES>> : BaseDialogFragmentVDBVMSelf<VDB, VM>(), IPagingKActivity<DES, VM> {

    @OptIn(OApiInit_ByLazy::class, OApiCall_BindLifecycle::class, OApiCall_BindViewLifecycle::class)
    private val _pagingKProxy by UtilKLazyJVM.lazy_ofNone { PagingKProxy<DES, VM>(this).apply { bindLifecycle(this@BasePagingKDialogFragmentVDBVMSelf) } }
